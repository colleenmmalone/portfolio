...
const Projects = [
    ...
    },
    {
        ...
        bg: 'bg-black',
        paragraphs: [
            "I designed this site with my musician friend in mind. I wanted a page that highlighted all the important things for a musician: music, merch, shows, booking. Many times I'll go to a local band's website and struggle to find these things.",
        ]
    },
    {
        title: "Supreme",
        to: "https://www.figma.com/proto/lkbPnwl2TOMaTFeqXHvPTg/Inspo-Board?page-id=214%3A1671&node-id=214-1675&viewport=1249%2C549%2C0.27&scaling=min-zoom&starting-point-node-id=214%3A1738&show-proto-sidebar=1",
        img: Imgs.Supreme,
